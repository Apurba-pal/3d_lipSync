...
Command: npx gltfjsx@6.2.3 public/models/demo_male.glb -o src/components/Avatar.jsx -r public
npx gltfjsx@6.2.3 public/models/demo_male.glb -o src/components/Avatar2.jsx -r public
npx gltfjsx public/models/demo_male.glb -o src/components/Avatar2.jsx -r public
*/
...
export function Avatar(props) {
    ...
    Object.values(corresponding).forEach((value) => {
      if (nodes.Wolf3D_Head && nodes.Wolf3D_Teeth) {
        ...
        if (smoothMorphTarget) {
          ...
          nodes.Wolf3D_Head.morphTargetInfluences[headTarget] = THREE.MathUtils.lerp(
            nodes.Wolf3D_Head.morphTargetInfluences[headTarget],
            0,
            morphTargetSmoothing
          );
          nodes.Wolf3D_Teeth.morphTargetInfluences[teethTarget] = THREE.MathUtils.lerp(
  ...
  const { nodes, materials } = useGLTF("/models/demo_male.glb");
...
useGLTF.preload("/models/demo_male.glb");
